/*
	...
	Purpose : Machine Project - Salary Computer	
*/
...
hourlySalaryRate(int i)
{
	...
	if(i==0)
	{
		printf("\n   Please input the Daily Salary Rate of the first user, User %d : ", i);
		scanf("%f", &dailySalaryRate);
	}
	else
	{
		printf("\n   Please input the Daily Salary Rate of the next user, User %d : ", i);
		scanf("%f", &dailySalaryRate);
	}
